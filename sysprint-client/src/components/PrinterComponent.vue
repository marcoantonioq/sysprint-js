      ...
      <q-card class="card">
        <q-card-section>
          ...
          <q-input
            ...
            @change="data.spool.range = data.spool.range?.replace(/[^0-9,-]/gi, '').trim()"
            class="validate"
          ...
          <q-expansion-item>
            ...
            <div class="text-left">
              ...
              <q-radio v-model="data.spool.sided" val="wo-sided-short-edge" label="Paisagem" />
            </div>
            <hr />
            <div class="text-left">
            ...
            <div class="text-left">
              ...
              <q-radio v-model="data.spool.orientation" :val="undefined" label="Padrão"></q-radio>
              <q-radio v-model="data.spool.orientation" val="4" label="90°"></q-radio>
              <q-radio v-model="data.spool.orientation" val="5" label="-90°"></q-radio>
              <q-radio v-model="data.spool.orientation" val="6" label="180°"></q-radio>
            </div>
            <hr />
            <div class="text-left">
              <div class="label">Qualidade:</div>
              <q-radio v-model="data.spool.quality" val="3" label="Rascunho"></q-radio>
              <q-radio v-model="data.spool.quality" val="4" label="Normal"></q-radio>
              <q-radio v-model="data.spool.quality" val="5" label="Melhor"></q-radio>
            </div>

            <hr />
            <div class="text-left">
              <div class="label">Tamanho:</div>
              <q-radio v-model="data.spool.media" :val="undefined" label="Automático"></q-radio>
